...
const PARTNERS = [
  { id: 'aerlingus',  name: 'Aer Lingus AerClub',          type: 'airline', alliance: 'Avios family' },
  { id: 'aeromexico', name: 'Aeroméxico Rewards',          type: 'airline', alliance: 'SkyTeam' },
  { id: 'aircanada',  name: 'Air Canada Aeroplan',         type: 'airline', alliance: 'Star Alliance' },
  { id: 'afklm',      name: 'Air France/KLM Flying Blue',  type: 'airline', alliance: 'SkyTeam' },
  { id: 'ana',        name: 'ANA Mileage Club',            type: 'airline', alliance: 'Star Alliance' },
  { id: 'avianca',    name: 'Avianca LifeMiles',           type: 'airline', alliance: 'Star Alliance' },
  { id: 'ba',         name: 'British Airways Avios',       type: 'airline', alliance: 'oneworld' },
  { id: 'cathay',     name: 'Cathay Asia Miles',           type: 'airline', alliance: 'oneworld' },
  { id: 'delta',      name: 'Delta SkyMiles',              type: 'airline', alliance: 'SkyTeam' },
  { id: 'emirates',   name: 'Emirates Skywards',           type: 'airline', alliance: 'independent' },
  { id: 'etihad',     name: 'Etihad Guest',                type: 'airline', alliance: 'independent' },
  { id: 'eva',        name: 'EVA Air Infinity MileageLands', type: 'airline', alliance: 'Star Alliance' },
  { id: 'finnair',    name: 'Finnair Plus',                type: 'airline', alliance: 'oneworld' },
  { id: 'iberia',     name: 'Iberia Plus',                 type: 'airline', alliance: 'oneworld' },
  { id: 'jetblue',    name: 'JetBlue TrueBlue',            type: 'airline', alliance: 'independent' },
  { id: 'qantas',     name: 'Qantas Frequent Flyer',       type: 'airline', alliance: 'oneworld' },
  { id: 'qatar',      name: 'Qatar Airways Avios',         type: 'airline', alliance: 'oneworld' },
  { id: 'singapore',  name: 'Singapore KrisFlyer',         type: 'airline', alliance: 'Star Alliance' },
  { id: 'southwest',  name: 'Southwest Rapid Rewards',     type: 'airline', alliance: 'independent' },
  { id: 'tap',        name: 'TAP Miles&Go',                type: 'airline', alliance: 'Star Alliance' },
  { id: 'turkish',    name: 'Turkish Miles&Smiles',        type: 'airline', alliance: 'Star Alliance' },
  { id: 'united',     name: 'United MileagePlus',          type: 'airline', alliance: 'Star Alliance' },
  { id: 'virgin',     name: 'Virgin Atlantic Flying Club', type: 'airline', alliance: 'SkyTeam' },
  { id: 'accor',      name: 'Accor Live Limitless',        type: 'hotel',   alliance: 'hotel' },
  { id: 'choice',     name: 'Choice Privileges',           type: 'hotel',   alliance: 'hotel' },
  { id: 'hilton',     name: 'Hilton Honors',               type: 'hotel',   alliance: 'hotel' },
  { id: 'hyatt',      name: 'World of Hyatt',              type: 'hotel',   alliance: 'hotel' },
  { id: 'ihg',        name: 'IHG One Rewards',             type: 'hotel',   alliance: 'hotel' },
  { id: 'marriott',   name: 'Marriott Bonvoy',             type: 'hotel',   alliance: 'hotel' },
  { id: 'wyndham',    name: 'Wyndham Rewards',             type: 'hotel',   alliance: 'hotel' },
];
